...
const StudentLoanCalculator: React.FC<StudentLoanCalculatorProps> = ({ calculator }) => {
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        <div className="lg:col-span-1 bg-brand-secondary p-6 rounded-lg shadow-lg space-y-6">
          <Input label={t('principal_balance')} id="loanAmount" type="number" value={loanAmount} onChange={e => setLoanAmount(e.target.value)} />
          ...
          <Input label={t('loan_repayment_term')} id="loanTerm" type="number" value={loanTerm} onChange={e => setLoanTerm(e.target.value)} />
