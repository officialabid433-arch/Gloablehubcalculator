...
interface CurrencyInflationAdjustedValueCalculatorProps {
  calculator: Calculator;
}

const CurrencyInflationAdjustedValueCalculator: React.FC<CurrencyInflationAdjustedValueCalculatorProps> = ({ calculator }) => {
...
export default CurrencyInflationAdjustedValueCalculator;
